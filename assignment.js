...
function budgetCalculator(numberOfWatchs, numberOfPhones, numberOfLaptops){
    if(numberOfWatchs < 0, numberOfPhones < 0, numberOfLaptops < 0){
        ...
        var totalCost = numberOfWatchs * 50 + numberOfPhones * 100 + numberOfLaptops * 500;
        return totalCost;
    }
}
...
var friends = ['Saif', 'Tahsin', 'Abdullah', 'Kawser', 'Mansoor', 'Mahmudullah','Nazrul'];
